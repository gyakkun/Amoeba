...
namespace Amoeba.Interface
{
    class ConnectionOptionsControlViewModel : ManagerBase
    {
        ...
        private void GetOptions()
        {
            ...
            // Custom
            {
                var config = _serviceManager.CustomConnectionConfig;
            ...
            // Bandwidth
            {
                this.ConnectionOptions.Bandwidth.BandwidthLimit = _serviceManager.BandwidthLimit;
                this.ConnectionOptions.Bandwidth.ConnectionCountLimit = _serviceManager.ConnectionCountLimit;
            }
        }
        ...
        public void SetOptions()
        {
            ...
            // Custom
            {
                ...
                _serviceManager.SetCustomConnectionConfig(
                    new CustomConnectionConfig(info.LocationUris, info.ConnectionFilters, info.ListenUris));
            }

            // Bandwidth
            {
                _serviceManager.BandwidthLimit = this.ConnectionOptions.Bandwidth.BandwidthLimit;
                _serviceManager.ConnectionCountLimit = this.ConnectionOptions.Bandwidth.ConnectionCountLimit;
            }
        }
