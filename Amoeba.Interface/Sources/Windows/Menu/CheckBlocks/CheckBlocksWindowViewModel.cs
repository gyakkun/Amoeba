...
namespace Amoeba.Interface
{
    class CheckBlocksWindowViewModel : ManagerBase
    {
        ...
        public ReactiveProperty<CheckBlocksProgressInfo> Info { get; private set; }
        ...
        {
            {
                this.Info = new ReactiveProperty<CheckBlocksProgressInfo>().AddTo(_disposable);
            ...
            {
                var progress = new Progress<CheckBlocksProgressInfo>(info =>
                {
                    try
                    {
