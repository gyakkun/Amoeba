...
namespace Amoeba.Messages
{
    ...
    public class CheckBlocksProgressReport
    {
    ...
    public class TcpConnectionReport
    {
    ...
    public class CustomConnectionReport
    {
        private long _catharsisBlockCount;
    ...
    public class NetworkConnectionReport
    {
        private byte[] _id;
    ...
    public class CacheContentReport
    {
    ...
    public class DownloadContentReport
    {
        private Metadata _metadata;
        private string _path;
